...
import com.beluga.cloudalibaba.service.PaymentService;
...
public class CircleBreakerController {
    ...
    //@SentinelResource(value = "fallback", exceptionsToIgnore = {IllegalArgumentException.class})  // 忽略异常
    //@SentinelResource(value = "fallback")    // 没有配置
    //@SentinelResource(value = "fallback", fallback = "handlerFallback")  // fallback只负责业务异常
    //@SentinelResource(value = "fallback", blockHandler = "blockHandler")   // blockHandler只负责sentinel控制台配置违规
    @SentinelResource(value = "fallback", fallback = "handlerFallback", blockHandler = "blockHandler") //两者都会生效
